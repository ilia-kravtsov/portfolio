            ...
            <section className={s.content}>
                <div className={s.contentLeft}>
                    <section className={s.personalInfo}>
                        <h3 className={toggleLight ? s.lightH3 : ''}>personal info: <div className={s.circle}></div><div className={s.headerLine}></div></h3>
               ...
               <div className={s.contentRight}>
                   <section className={s.experience_education}>
                       <h3 className={toggleLight ? s.lightH3 : ''}>EXPERIENCE & EDUCATION:<div className={s.circle}></div><div className={s.headerLine}></div></h3>
                       ...
                       <section className={s.programming_training}>
                           <h3 className={toggleLight ? s.lightH3 : ''}>Programming training:<div className={s.circle}></div><div className={s.headerLine}></div></h3>
